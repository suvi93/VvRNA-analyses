# ------------------------------------------------------------------
# sbg_xavstackedbar_fig5.R
#
# Generates Figure 5: stacked bar plots showing the proportion of
# male-biased, female-biased, and unbiased genes per chromosomal
# region and tissue, for P24X0 and P24XY races.
#
# Input:  gene counts by bias category/region/tissue (hardcoded
#         summary tables derived from deseq2.R output)
# Output: sbg_xavstackedbar.pdf (Figure 5 of the paper)
#
